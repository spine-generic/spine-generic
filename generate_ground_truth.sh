...
# mkdir derivatives/labels/${sub}
# mkdir derivatives/labels/${sub}/anat
ofolder="derivatives/labels/${sub}/anat"
...
if [ -e "${file_t1w}_seg_manual.nii.gz" ]; then
  ...
  # Segment spinal cord
  sct_deepseg_sc -i ${file_t1w_mts}.nii.gz -c t1  -ofolder "../${ofolder}" -qc ${PATH_QC}
